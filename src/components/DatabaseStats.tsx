    ...
    <div className="flex flex-wrap items-center justify-center gap-6 py-4 px-6 bg-muted/30 rounded-xl border border-border/50">
      <div className="flex items-center gap-2 text-sm">
        <Database className="h-4 w-4 text-primary" />
          ...
          <span className="font-semibold text-foreground">{companyCount}</span> {t('companies')}
        </span>
      </div>
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <span className="text-muted-foreground">
          <span className="font-semibold text-foreground">{stats.verifiedCount}</span> {t('verified')}
        </span>
      </div>
